...
class ScheduleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $schedules = Schedule::where('teacher_id',$id)->with(['room', 'teacher', 'grade'])
    ...
    public function selected(Schedule $schedule, $date)
    {
        ...
        return view('teacher.schedule.selected')->with(compact('schedule', 'picked'));
    }
    ...
    public function room(Schedule $schedule)
    {
         ...
         $schedule->where('id',$schedule->id)->with('schedule.student','grade','room','teacher')->first();
          return view('teacher.schedule.room')->with(compact('schedule'));
    }
    ...
    {
        $schedule = Schedule::where('id',$schedule->id)->with('schedule.student','grade','room','teacher')->first();
        return view('teacher.schedule.show')->with(compact('schedule'));
    }
