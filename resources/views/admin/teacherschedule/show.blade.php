            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.teacherschedule.index') }}" class="btn btn-info">Back</a>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        dateClick: function(info) {
            ...
            window.location.href = "{{ route('admin.teacherschedule.selected', ['schedule' => ':schedule', 'date' => ':date']) }}"
